...
function ProductPages() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${AppRoute}api/getproductbyid/${_id}`)
      .then((response) => {
  ...
  const styling = {
    backgroundImage: `url(${`https://img.freepik.com/free-photo/brick-wall-background-wallpaper-texture-concept_53876-65453.jpg`})`,
      ...
      <div className="container" >
        <div className="text-center py-5">
          ...
          <div className="d-grid gap-4">
            ...
            <div className='d-flex justify-content-center'>
              <button className="btn btn-dark" style={{ width: '150px' }} onClick={addtoCart} disabled={cart_state.cart.some(item => item.id === product._id)}>
                {cart_state.cart.some(item => item._id === product._id) ? "Already in Cart" : "Add to Cart"}
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="col-md-6">
            ...
            <div className="container">
              ...
              <div>
                ...
                <button className='my-5 btn btn-dark ' onClick={submitReview}>Submit review</button>
