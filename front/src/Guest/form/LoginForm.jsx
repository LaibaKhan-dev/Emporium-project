      ...
      <div className="p-5 bg-dark rounded text-white form-container ">
        {signupMode ? (
          <form onSubmit={handleFormSubmit}>
            ...
            <button type="submit" style={{ width: '100px', backgroundColor: 'rgb(195 152 92)' }} className="btn mx-1" >
              Sign Up
            </button>
            <button
              type="button"
          ...
          <form onSubmit={handleFormSubmit}>
            ...
            <button type="submit" style={{ width: '80px', backgroundColor: 'rgb(195 152 92)' }} className="btn mx-1">
              Login
            </button>
            <button
              type="button"
              style={{ width: '100px', Color: 'rgb(195 152 92)' }}
              className="btn btn-link mx-1"
